...
const REQUIRED_DOCS: Record<string, { id: string; label: string }[]> = {
    name: [
        { id: "nameProof1", label: "Proof of Name (e.g. Birth Certificate / Passport)" },
        { id: "nameProof2", label: "Supporting Identity Proof" },
    ],
    dob: [
        { id: "dobProof", label: "Proof of Date of Birth (e.g. Birth Certificate / School Certificate)" },
    ],
    gender: [
        { id: "genderProof", label: "Gender Change Certificate / Affidavit" },
    ],
    address: [
        { id: "addressProof1", label: "Proof of Address (e.g. Utility Bill / Bank Statement)" },
        { id: "addressProof2", label: "Supporting Address Proof (e.g. Rent Agreement)" },
    ],
    mobile: [
        { id: "mobileProof", label: "Identity Proof linked to new mobile" },
    ],
};



export default function AadhaarUpdateScreen() {
    ...
    const validateStep2 = () => {
        if (!selectedType) return Alert.alert("Required", "Please select an update type");
        ...
        switch (selectedType) {
            ...
            case "mobile": if (newMobile.length !== 10 || !isUpdateMobileVerified) return Alert.alert("Required", "Verify new mobile number"); break;
        }
            ...
            <SafeAreaView style={s.safe}>
                ...
                <View style={s.header}>
                    ...
                    <View style={s.headerContent}>
                        <Text style={s.headerTitle}>Update Aadhaar</Text>
                            ...
                            <View>
                                <View style={s.sectionHeader}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={s.sectionSub}>Verify your existing Aadhaar</Text>
                                    </View>
                                </View>
                                ...
                                <View style={s.card}>
                                    ...
                                    <View style={s.inputRow}>
                                        ...
                                        <TextInput style={s.field} placeholder="XXXX XXXX XXXX" keyboardType="numeric" maxLength={14} value={aadhaarNumber} onChangeText={formatAadhaar} />
                                    </View>
                                    ...
                                    <View style={s.otpRow}>
                                        ...
                                        <TouchableOpacity style={s.verifyBtn} onPress={handleSendOtp} disabled={mobileNumber.length !== 10}>
                            ...
                            <View>
                                    ...
                                    {([
                                        ...
                                        <TouchableOpacity key={t.id}
                                            ...
                                            onPress={() => {
                                                ...
                                                setNewName(""); setNewDob(""); setNewGender(""); setNewAddress(""); setNewState(""); setNewPincode(""); setNewMobile("");
                                                setIsUpdateMobileOtpSent(false); setIsUpdateMobileVerified(false);
                                            }}>
                                ...
                                {selectedType && (
                                    <View>
                                        {/* New Value Input */}
                                        <View style={s.card}>
                                            <Text style={s.formHeader}>Enter Updated Details</Text>

                                            {selectedType === "name" && (
                                                <View>
                                                    <Text style={s.inputLabel}>New Full Name *</Text>
                                                    <View style={s.inputRow}>
                                                        <Ionicons name="person-outline" size={18} color="#64748B" />
                                                        <TextInput style={s.field} placeholder="Full legal name as per proof" value={newName} onChangeText={setNewName} />
                                                    </View>
                                                </View>
                                            )}
                                            ...
                                            {selectedType === "dob" && (
                                                <View>
                                                    <Text style={s.inputLabel}>New Date of Birth *</Text>
                                                    <View style={s.inputRow}>
                                            ...
                                            {selectedType === "gender" && (
                                                <View>
                                                    <Text style={s.inputLabel}>Select New Gender *</Text>
                                            ...
                                            {selectedType === "address" && (
                                                <View>
                                                    ...
                                                    <View style={[s.inputRow, { height: 80, alignItems: 'flex-start', paddingTop: 10 }]}>
                                                        <TextInput style={[s.field, { textAlignVertical: 'top' }]} placeholder="House No, Street, Locality" value={newAddress} onChangeText={setNewAddress} multiline />
                                                    </View>
                                                    <View style={{ flexDirection: 'row', gap: 12, marginTop: 12 }}>
                                                        ...
                                                        <View style={{ flex: 1 }}>
                                                            ...
                                                            <View style={s.inputRow}><TextInput style={s.field} placeholder="6 digits" value={newPincode} onChangeText={setNewPincode} keyboardType="numeric" maxLength={6} /></View>
                                                        </View>
                                                    </View>
                                                </View>
                                            )}
                                            ...
                                            {selectedType === "mobile" && (
                                                <View>
                                                    <Text style={s.inputLabel}>New Mobile Number *</Text>
                                                    <View style={s.otpRow}>
                                                        <View style={[s.inputRow, { flex: 1 }]}>
                                                            <TextInput style={s.field} placeholder="Enter new mobile" value={newMobile} onChangeText={setNewMobile} keyboardType="numeric" maxLength={10} />
                                                        </View>
                                                        <TouchableOpacity style={s.verifyBtn} onPress={() => setIsUpdateMobileOtpSent(true)}>
                                                            <Text style={s.verifyBtnText}>Verify</Text>
                                                        </TouchableOpacity>
                                                    </View>
                                                    {isUpdateMobileOtpSent && (
                                                        <View style={{ marginTop: 16 }}>
                                                            <Text style={s.inputLabel}>OTP for New Mobile *</Text>
                                                            <View style={s.otpRow}>
                                                                <View style={[s.inputRow, { flex: 1 }]}><TextInput style={s.field} placeholder="6 digit code" value={updateMobileOtp} onChangeText={setUpdateMobileOtp} keyboardType="numeric" maxLength={6} /></View>
                                                                <TouchableOpacity style={[s.verifyBtn, isUpdateMobileVerified && { backgroundColor: '#E8F5E9' }]} onPress={() => setIsUpdateMobileVerified(true)}>
                                                                    <Text style={[s.verifyBtnText, isUpdateMobileVerified && { color: '#2E7D32' }]}>{isUpdateMobileVerified ? "✓ Done" : "Confirm"}</Text>
                                                                </TouchableOpacity>
                                                            </View>
                                                        </View>
                                                    )}
                            ...
                            <View>
                                <View style={s.sectionHeader}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={s.sectionSub}>Verify your updated details</Text>
                                    </View>
                                </View>

                                <View style={s.card}>
                                    <View style={s.reviewRow}>
                                        <Text style={s.reviewLabel}>Aadhaar Number</Text>
                                        <Text style={s.reviewVal}>XXXX XXXX {aadhaarNumber.slice(-4)}</Text>
                                    </View>
                                    ...
                                    <View style={s.reviewRow}>
                                        ...
                                        <Text style={[s.reviewVal, { color: '#2E7D32' }]}>
                                            {selectedType === "name" ? newName : selectedType === "dob" ? newDob : selectedType === "gender" ? newGender : selectedType === "address" ? `${newAddress}, ${newState} - ${newPincode}` : newMobile}
                                        </Text>
                                    </View>
                                    <View style={s.divider} />
                                    <View style={s.reviewRow}>
                                ...
                                <View style={s.warningBox}>
                                    ...
                                    <Text style={s.warningText}>Ensure proof documents are clear and valid to avoid rejection of your request.</Text>
                                </View>
...
const s = StyleSheet.create({
    ...
    safe: { flex: 1 },
    // Header - no circle, plain back arrow
