...
export default function UpdateGasDetailsScreen() {
    ...
    const handleFetchConnectionDetails = () => {
        if (!formData.consumerNumber || !formData.mobileNumber || !documents.previousBill) {
            Alert.alert("Details Required", "Please fill all fields and upload previous gas bill");
            return;
        }
        if (!isOtpVerified) {
    ...
    const handleSaveAndContinue = () => {
        ...
        if (formData.transferRequest.newOwnerName && !documents.transferProof) {
            Alert.alert("Document Required", "Transfer proof is required");
            return;
        }
        setCurrentStep(3);
    };
    ...
    const handleSubmitRequest = () => {
        ...
        setTimeout(() => {
            const ref = "GAS" + Math.floor(Math.random() * 9000000 + 1000000);
            setReferenceId(ref);
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={[styles.successContainer, { flex: 1, justifyContent: 'center', alignItems: 'center' }]}>
                    ...
                    <Text style={styles.successSubtitle}>Your gas details update request has been received</Text>
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerCenter}>
                        ...
                        <Text style={styles.headerSubtitle}>Gas connection (गॅस बिल माहिती)</Text>
                    </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                    ...
                    {currentStep === 1 && (
                        <View style={styles.docsRequiredBox}>
                            ...
                            <View style={styles.docsList}>
                                <Text style={styles.docBullet}>• Consumer Number / LPG ID</Text>
                                <Text style={styles.docBullet}>• Previous Gas Bill Copy</Text>
                    ...
                    {currentStep === 1 && (
                        <View>
                            ...
                            <View style={styles.formCard}>
                                ...
                                <Label text="LPG ID (if applicable)" />
                                <Input
                                    value={formData.lpgId}
                                    onChangeText={(v: string) => setFormData({ ...formData, lpgId: v.replace(/\D/g, '').substring(0, 17) })}
                                    placeholder="Enter 17-digit LPG ID"
                                    icon="card-outline"
                                ...
                                <View style={{ marginTop: 20 }}>
                                    <Label text="Upload Previous Gas Bill / Receipt *" />
                                    <DocUploadItem
                                        title="Previous Bill Copy"
                    ...
                    {currentStep === 2 && (
                        <View>
                            ...
                            <SectionTitle title="2. Address Update" icon="location" />
                            <View style={styles.formCard}>
                                ...
                                <View style={{ flexDirection: 'row', gap: 10 }}>
                                    ...
                                    <View style={{ flex: 1 }}>
                                        <Label text="Pincode" />
                                        <Input value={formData.address.pincode} onChangeText={(v: string) => setFormData({ ...formData, address: { ...formData.address, pincode: v.replace(/\D/g, '').substring(0, 6) } })} placeholder="6-digit Pincode" keyboardType="number-pad" maxLength={6} />
                                    </View>
                                </View>
                                ...
                                {(formData.address.houseNo || formData.address.street) && (
                                    <View style={{ marginTop: 10 }}>
                                        ...
                                        <DocUploadItem
                                            title="Address Proof"
                                            hint="Tax Receipt / Electricity Bill"
                    ...
                    {currentStep === 3 && (
                        <View>
                            ...
                            <View style={styles.summaryCard}>
                                <SummarySection title="Consumer Number" value={formData.consumerNumber} onEdit={() => setCurrentStep(1)} />
                                <SummarySection title="LPG ID" value={formData.lpgId || "Not Provided"} onEdit={() => setCurrentStep(1)} />
                                ...
                                <View style={styles.attachedDocsList}>
                                    {documents.previousBill && <DocBadge name="Previous Gas Bill" />}
                            ...
                            >
                                ...
                                <Text style={styles.declarationText}>I confirm that the information provided is correct.</Text>
                            </TouchableOpacity>
...
const SummarySection = ({ title, value, onEdit }: any) => (
    <View style={styles.summarySection}>
        <View style={{ flex: 1 }}>
            ...
            <Text style={styles.sumValue}>{value || "No Change"}</Text>
        </View>
