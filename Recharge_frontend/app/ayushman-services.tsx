...
export default function AyushmanServicesScreen() {
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerCenter}>
                        <Text style={styles.headerTitle}>Ayushman Bharat</Text>
                        <Text style={styles.headerSubtitle}>Apply for Health Insurance under PM-JAY</Text>
                    </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                        ...
                        <View style={styles.cardContent}>
                            <View style={styles.cardHeader}>
                                <View style={styles.iconCircle}>
                                    <MaterialCommunityIcons name="heart-pulse" size={28} color="#0A4DA3" />
                                </View>
                                <View style={styles.titleSection}>
                                    <Text style={styles.cardTitle}>Pradhan Mantri Jan Arogya Yojana</Text>
                                    <Text style={styles.cardSubtitle}>Ayushman Bharat (PM-JAY) Scheme</Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.badgesRow}>
                                <View style={styles.badge}>
                                    ...
                                    <Text style={styles.badgeText}>₹5 Lakh Coverage</Text>
                                </View>
                                <View style={styles.badge}>
                                    <Ionicons name="checkmark-circle" size={16} color="#2E7D32" />
                                    <Text style={styles.badgeText}>Cashless Treatment</Text>
                                </View>
                                <View style={styles.badge}>
                                    <Ionicons name="checkmark-circle" size={16} color="#2E7D32" />
                                    <Text style={styles.badgeText}>Govt & Pvt Hospitals</Text>
                                </View>
                                <View style={styles.badge}>
                                    <Ionicons name="checkmark-circle" size={16} color="#2E7D32" />
                                    <Text style={styles.badgeText}>Family Floater</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                        ...
                        <View style={styles.blueGradient}>
                            <View style={styles.serviceHeaderRow}>
                                <View style={styles.serviceIcon}>
                                    <MaterialCommunityIcons name="card-plus-outline" size={28} color="#0A4DA3" />
                                </View>
                                <View style={styles.serviceContent}>
                                    <Text style={styles.serviceTitle}>New Application / e-KYC</Text>
                                    <Text style={styles.serviceHindi}>नवीन आयुष्मान भारत अर्ज / ई-केवायसी</Text>
                                </View>
                            </View>

                            <View style={styles.serviceBottomRow}>
                                <Text style={styles.serviceDesc}>Apply or Verify Eligibility for Ayushman Card</Text>
                                <TouchableOpacity style={styles.blueButton} onPress={() => router.push('/new-ayushman-application')}>
                    ...
                    <View style={styles.noteCard}>
                        <View style={styles.noteHeader}>
                            ...
                            <Text style={styles.noteTitle}>Eligibility Basis:</Text>
                        </View>
                        <Text style={styles.noteText}>
                            Eligibility is based on the SECC 2011 database or for families holding eligible ration cards. Aadhaar verification is mandatory for all family members.
                        </Text>
                    </View>
                </ScrollView>
            </SafeAreaView>
