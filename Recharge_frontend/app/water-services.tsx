...
export default function WaterServicesScreen() {
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerCenter}>
                        <Text style={styles.headerTitle}>Water Bill Services</Text>
                        <Text style={styles.headerSubtitle}>View & Update Water Connection</Text>
                    </View>
                ...
                >
                            ...
                            <View style={styles.cardHeader}>
                                ...
                                <View style={styles.titleSection}>
                                    ...
                                    <Text style={styles.cardSubtitle}>
                                        Official Water Service Hub
                                    </Text>
                                </View>
                            </View>

                            <View style={styles.badgesRow}>
                                <Badge text="Official Water Portal" />
                        ...
                        <View style={styles.serviceCardUpdate}>
                            <View style={styles.blueGradient}>
                                ...
                                <View style={styles.serviceBottomRow}>
                                    <Text style={styles.serviceDescUpdate}>Update mobile, name correction, address or connection category</Text>
                                    <TouchableOpacity
                                        style={styles.blueButton}
                                        onPress={() => router.push("/update-water-details")}
                                    >
                    ...
                    <View style={styles.processCard}>
                        ...
                        <Text style={styles.stepText}>
                            Ensure you have your Consumer Number and a copy of your recent water bill before starting the update process. Name and address corrections require supporting documents like Aadhaar or Identity Proof.
                        </Text>
                    </View>
